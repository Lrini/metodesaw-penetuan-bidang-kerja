  ...
  <div class="content-wrapper">
      ...
      <div class="box">
        <div class="box-header with-border">
         ...
         <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Input Penempatan</h3>
			 </div>
			 <!-- /.box-header -->
            <!-- form start -->
					...
					<select name= "nip" id="nip" class="form-control" type="text">
						<option>NIP</option>
							<?php while ($data = mysql_fetch_array($result)) 
									{ ?>
										<option value='<?php echo $data['nip'] ?>'><?php echo $data['nip'] ?> | <?php echo $data['nama'] ?></option>
									<?php } ?>
					</select>
                </div>
			  <div class="form-group">
                  <label for="exampleInputEmail1">KEMAMPUAN</label>
                  <input type="text" class="form-control" id="kemampuan" name="kemampuan"/>
                </div>
			    <div class="form-group">
                  <label for="exampleInputEmail1">DIMILIKI</label>
                  <input type="text" class="form-control" id="miliki" name="miliki"/>
                </div>
				<div class="form-group">
    ...
    include 'koneksi.php';
	 if(isset($_POST['simpan'])){
        ...
        $sql = mysql_query("INSERT INTO kriteria (nip,kemampuan,miliki,ket)values 
		('$nip','$kemampuan','$miliki','$keterangan')");

       if($sql){
          ?>
          <script type="text/javascript">
            alert('Berhasil');window.location='kriteria.php';
          </script>
          <?php
        }
	 }
