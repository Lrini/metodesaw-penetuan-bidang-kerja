					   ...
					   <tbody>
                        <tr>
                          <?php 
								...
								<td>
									<div class="btn-group">
										   <a class="btn btn-primary fa fa-edit" href="edit_pegawai.php?nip=<?php echo $row['nip'] ?>"><i class="icon_plus_alt2"></i></a>
                                          	<a href="hapus_pegawai.php?nip=<?php echo $row['nip']?>" onclick ="return konfirmasi()" class="btn btn-danger"><i class="fa fa-close"></i></a>
                                  </div>
								</td>
                        </tr>
						<?php
