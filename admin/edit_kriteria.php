  ...
  <div class="content-wrapper">
        ...
        <div class="box-header with-border">
         ...
         <div class="box box-primary">
			...
			<?php 
					include 'koneksi.php';
					$nip=$_GET['nip'];
					$data = mysql_query("SELECT * from kriteria INNER JOIN pegawai ON kriteria.nip= pegawai.nip");
                  ...
                  <label for="exampleInputEmail1">NIP</label>
					<select name= "nip" id="nip" class="form-control" type="text">
						<option>NIP</option>
							<?php
									{ ?>
										<option value='<?php echo $edit['nip'] ?>'><?php echo $edit['nip'] ?> | <?php echo $edit['nama'] ?></option>
									<?php } ?>
					</select>
                </div>
			  <div class="form-group">
                  <label for="exampleInputEmail1">Kemampuan</label>
                  <input type="text" class="form-control" name="kemampuan" value="<?php echo $edit['kemampuan'] ?>"/>
                </div>
			    <div class="form-group">
                  <label for="exampleInputEmail1">MILIKI</label>
                   <input type="text" class="form-control" name="miliki" value="<?php echo $edit['miliki'] ?>"/>
                </div>
				<div class="form-group">
    ...
    include 'koneksi.php';
	 if(isset($_POST['simpan'])){
        ...
        $sql = mysql_query("update kriteria set kemampuan='$kemampuan',miliki='$miliki',ket='$keterangan' where nip='$nip'");

       if($sql){
          ?>
          <script type="text/javascript">
            alert('Berhasil');window.location='tkriteria.php';
          </script>
          <?php
        }
	 }
