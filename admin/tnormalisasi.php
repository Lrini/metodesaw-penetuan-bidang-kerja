         ...
         <div class="box box-primary">
            <div class="box-header with-border">
			 ...
			 <!-- /.box-header -->
			  ...
			  <?php
				include "koneksi.php";
					$bobot = array(0.4, 0.25, 0.35);// pendidikan=40%,thn_kerja=25%,skill=35%
				...
				$sql2 = mysql_query("SELECT * FROM t_normal");
			  ?>
				<table class="table table-striped table-bordered data">
					...
					<?php
						...
						echo "<tr>
							<td>".getNama($dt2['nip'])."</td>
							<td align='center'>".round($dt2['c1']/$max['maxc1'],2)."</td>
							<td align='center'>".round($dt2['c2']/$max['maxc2'],2)."</td>
							<td align='center'>".round($dt2['c3']/$max['maxc3'],2)."</td>
						</tr>";
					}
					?>
					</tbody>
