  ...
  <div class="content-wrapper">
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
                  ...
                  <select name="pendidikan" id="pendidikan" class="form-control"> 
					...
					<option value="40">S1</option>
					<option value="50">S2</option>
				...
				<div class="form-group">
                  ...
                  <select name="thn_kerja" id="thn_kerja" class="form-control"> 
					<option value="">Lama bekerja</option>
					<option value="10">1 Tahun</option>
					<option value="20">2 Tahun</option>
					<option value="30">3 Tahun</option>
					<option value="40">4 Tahun</option>
					<option value="50">5 Tahun</option>
					<option value="60">6 Tahun</option>
					<option value="65">7 Tahun</option>
					<option value="70">8 Tahun</option>
					<option value="75">9 Tahun</option>
					<option value="80">10 Tahun</option>
				  </select>
                </div>
				<div class="form-group">
                  ...
                  <select name="keterangan" id="keterangan" class="form-control"> 
					...
					<option value="10">Sopir</option>
					<option value="20">Tenanga admin</option>
					<option value="30">Staf admin</option>
					<option value="40">Operator Komputer</option>
					<option value="50">Kontrak</option>
				  </select>
                </div>
              </div>
        <!-- /.box-body -->
    ...
    include 'koneksi.php';
	 if(isset($_POST['simpan'])){
        ...
        $sql = mysql_query("INSERT INTO pegawai (nip,nik,nama,alamat,jk,tempat,tgl_lahir,pendidikan,tgl_kerja,thn_kerja,ket)values 
		('$nip','$nik','$nama','$alamat','$jk','$tempat','$tgl_lahir','$pendidikan','$tgl_kerja','$thn_kerja','$keterangan')");
		$sql1 = mysql_query("INSERT INTO t_normal (id_normal,nip,c1,c2,c3) VALUES(NULL,'$nip','$pendidikan','$thn_kerja','$keterangan')");
       if($sql && $sql1){
          ?>
          <script type="text/javascript">
            alert('Berhasil');window.location='pegawai.php';
          </script>
          <?php
        }
	 }
