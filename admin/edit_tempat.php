  ...
  <div class="content-wrapper">
        ...
        <div class="box-header with-border">
         ...
         <div class="box box-primary">
			...
			<?php 
					include 'koneksi.php';
					$nip=$_GET['nip'];
					$data = mysql_query("SELECT * from penempatan INNER JOIN pegawai ON penempatan.nip= pegawai.nip");
			...
			?>
			  ...
			  <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="posisi" value="<?php echo $edit['posisi'] ?>"/>
                </div>
			    <div class="form-group">
                  <label for="exampleInputEmail1">BAGIAN</label>
                   <input type="text" class="form-control" name="bagian" value="<?php echo $edit['bagian'] ?>"/>
                </div>
				<div class="form-group">
    ...
    include 'koneksi.php';
	 if(isset($_POST['simpan'])){
        ...
        $sql = mysql_query("update penempatan set posisi='$posisi',bagian='$bagian',ket='$keterangan' where nip='$nip'");

       if($sql){
          ?>
          <script type="text/javascript">
            alert('Berhasil');window.location='ttempat.php';
          </script>
          <?php
        }
	 }
